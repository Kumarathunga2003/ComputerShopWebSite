...
$products = $conn->query("SELECT * FROM products WHERE type='Monitors' ORDER BY id DESC");
...
<title>Monitors - Computer Shop</title>
<style>
...
footer a { color:#00bfff; text-decoration:none; margin:5px 0; display:block; }
