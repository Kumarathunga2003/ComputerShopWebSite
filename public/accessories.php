...
$products = $conn->query("SELECT * FROM products WHERE type='Accessories' ORDER BY id DESC");
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<title>Accessories - Computer Shop</title>
<style>
...
<div id="sidePanel">
  ...
  <a href="graphics.php">Graphic Cards</a>
